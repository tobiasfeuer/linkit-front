...
const translations = {
  es: {
    hero: {
      titlePrefix: "¿Buscas ",
      titleHighlight: " contratar talento que asegure rendimiento",
      titleSuffix: "?",
      description:
        "En LinkIT te conectamos con el mejor talento sin costos por adelantado. Solo pagás cuando encontrás al candidato ideal.",
    },
    stats: {
      companies: "Empresas confían en nosotros",
      professionals: "Profesionales en nuestra red",
      successRate: "Tasa de éxito en contrataciones",
    },
    cta: {
      title: "¿Listo para encontrar el talento que necesitás?",
      description:
        "Nuestro equipo de expertos está listo para ayudarte a armar el equipo ideal para tu empresa.",
      button: "Agendar llamada",
    },
    form: {
      title: "¡Comienza ahora!",
      subtitle:
        "Completa el formulario y nos pondremos en contacto contigo para coordinar una videollamada cuanto antes",
    },
  },
  en: {
    hero: {
      titlePrefix: "Are you looking to ",
      titleHighlight: "hire talent that delivers performance",
      titleSuffix: "?",
      description:
        "At LinkIT we connect you with top talent with no upfront costs. You only pay when you find the right hire.",
    },
    stats: {
      companies: "Companies trust us",
      professionals: "Professionals in our network",
      successRate: "Success rate in hiring",
    },
    cta: {
      title: "Ready to find the talent you need?",
      description:
        "Our team of experts is ready to help you build the ideal team for your company.",
      button: "Schedule a call",
    },
    form: {
      title: "Get Started Now!",
      subtitle:
        "Complete the form and we will contact you to schedule a video call as soon as possible",
    },
  },
}
            ...
            <div className="lg:w-5/12">
              ...
              >
                <h1 className="text-4xl xl:text-5xl lg:text-4xl md:text-4xl xs:text-3xl font-bold mb-6">
                  <span className="inline-block">{t("hero.titlePrefix")}</span>
                  <span className="text-linkIt-300 font-extrabold">{t("hero.titleHighlight")}</span>
                  <span className="inline-block">{t("hero.titleSuffix")}</span>
                </h1>
              ...
              <div className="space-y-4 mt-8">
                <BenefitItem
                  ...
                  text="Candidatos en 5 días hábiles"
